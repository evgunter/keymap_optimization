...
pub fn gen_random_config_with_trial_decoder<K: Key, const N: usize, L: Layout<K,N>, I, S: ChordSampler<K, N, L, R, I>, C: ChordTrialUtils<K, N, L, R, I, S>>(initialization_info: &I) -> Result<(Vec<u8>, C), Box<dyn Error>> {
